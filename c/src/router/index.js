...
export const constantRouterMap = [
  ...
  { path: '/home/:nav', component: () => import('@/views/home/index'), hidden: true},
    ...
    children: [
      {
        path: 'myinfo',
        name: 'myinfo',
        component: () => import('@/views/myzone/myinfo'),
        meta: { title: '个人信息', icon: 'form' }
      },
      {
        path: 'myfollow',
        name: 'myfollow',
        component: () => import('@/views/myzone/myfollow'),
        meta: { title: '我的关注', icon: 'form' }
      },
      {
        path: 'myfan',
        name: 'myfan',
        component: () => import('@/views/myzone/myfan'),
